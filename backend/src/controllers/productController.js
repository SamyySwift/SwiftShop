...
const createProductReview = asyncHandler(async (req, res) => {
  ...
  if (product) {
    ...
    // Populate the user field with additional fields (e.g., profileImage)
    await product.reviews.populate({
      path: "user",
      select: "name profileImage", // Add other fields you need from the User model
    });
